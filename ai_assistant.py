"""
Claude AI Integration for NDCGenie AI
...
class ClaudeAssistant:
    ...
    def _build_system_prompt(
        ...
        if not transactions:
            return "You are NDCGenie AI. No transactions loaded."
        ...
        return f"""You are NDCGenie AI, an airline customer service assistant.
